...
remain user friendly (who or whatever the user may be). With that in mind, Kepler
...
working with Kepler are the following:
...
As part of the Kepler project, we will only consider the first 2 modes of
