...
在 Kepler 中，我们把同步一个新节点或一段时间未跟上链的节点，并将其升级到最新的已知工作量最大的块的过程称为“同步”（"sync"）。 初始块下载（或 IBD）通常在其他区块链中被采用，但这对 Kepler 来说这是有问题的，因为它通常不会下载完整的块。

简而言之，在 Kepler 中的快速同步会执行以下操作：
