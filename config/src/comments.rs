...
#test_miner_wallet_url = \"http://127.0.0.1:7415\"
...
#seeds = [\"192.168.0.1:7414\",\"192.168.0.2:7414\"]

#hardcoded peer lists for allow/deny
#will *only* connect to peers in allow list
#peers_allow = [\"192.168.0.1:7414\", \"192.168.0.2:7414\"]
#will *never* connect to peers in deny list
#peers_deny = [\"192.168.0.3:7414\", \"192.168.0.4:7414\"]
#a list of preferred peers to connect to
#peers_preferred = [\"192.168.0.1:7414\",\"192.168.0.2:7414\"]
