...
lazy_static! {
	pub static ref KEPLER_BASIC_REALM: HeaderValue =
		HeaderValue::from_str("Basic realm=KeplerAPI").unwrap();
	pub static ref KEPLER_FOREIGN_BASIC_REALM: HeaderValue =
		HeaderValue::from_str("Basic realm=KeplerForeignAPI").unwrap();
}
